...
urlpatterns = [
    ...
    path(f"{config('ADMIN_URL')}/default/manager/", include("core.manager.urls")),
    path(f"{config('ADMIN_URL')}/test/manager/", include("core.manager.urls")),
    path(f"{config('ADMIN_URL')}/fix-bazi/manager/", include("core.manager.urls")),
